...
const services = [
  ...
  },
  {
    ...
    description: "Güvenlik standartlarına uygun araç modifikasyonları için uygunluk belgeleri.",
  },
  {
    title: "Periyodik Muayene",
    description: "Ticari araçlar için zorunlu periyodik muayene ve dokümantasyon hizmetleri.",
  },
  {
    title: "CE Belgesi",
    description: "AB standartlarına uygun araç ve ekipmanlar için CE belgesi danışmanlığı.",
  },
  {
    title: "Teknik Proje Hazırlama",
    description: "Araç modifikasyonları ve özel donanımlar için teknik proje dokümantasyonu.",
  },
  {
    title: "Hızlı Belgelendirme",
    description: "Acil ihtiyaçlar için hızlandırılmış belgelendirme ve onay süreçleri.",
  },
];

const steps = [
  { id: "01", title: "İlk Görüşme", text: "İhtiyaçlarınızı dinliyor ve size en uygun belgelendirme sürecini planlıyoruz." },
  { id: "02", title: "Dokümantasyon", text: "Gerekli tüm teknik döküman ve projeleri eksiksiz şekilde hazırlıyoruz." },
  { id: "03", title: "TSE Başvuru", text: "Hazırlanan dosyalarla TSE'ye resmi başvuru yapıyor ve süreci takip ediyoruz." },
  { id: "04", title: "Belge Teslimi", text: "Onaylanan belgelerinizi size teslim ediyor ve süreç sonrası destek sunuyoruz." },
];
    ...
    <main className="text-slate-900">
          ...
          >
            <div>
              <span className="inline-flex rounded-full border border-blue-300/20 bg-blue-500/15 px-3 py-1 text-xs font-medium text-blue-200">
                TSE Onaylı Belgelerde Güvenilir Hizmet
              </span>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-2xl">
              <div className="grid gap-3 sm:grid-cols-2">
                <article className="rounded-xl bg-white/10 p-5">
                  <p className="text-3xl font-bold text-blue-300">500+</p>
                  <p className="mt-1 text-sm text-slate-200">Tamamlanan Proje</p>
                </article>
                <article className="rounded-xl bg-white/10 p-5">
                  <p className="text-3xl font-bold text-blue-300">%98</p>
                  <p className="mt-1 text-sm text-slate-200">Müşteri Memnuniyeti</p>
                </article>
              </div>
              <article className="mt-3 rounded-xl bg-white/10 p-5">
                <p className="text-sm text-slate-100">TSE Sertifikalı Onaylı Belgeler</p>
      ...
      <section id="hizmetler">
        <div className="mx-auto flex min-h-[calc(100svh+96px)] max-w-6xl flex-col justify-center px-4 py-20 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-5 text-3xl font-bold sm:text-5xl">Kapsamlı TSE Belgelendirme Çözümleri</h2>
      ...
      <section id="surec" className="bg-slate-50">
        <div className="mx-auto flex min-h-[calc(100svh+96px)] max-w-6xl flex-col justify-center px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold sm:text-5xl">Basit ve Hızlı Süreç</h2>
            <p className="mt-4 text-slate-600">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((step) => (
              <article key={step.id} className="rounded-2xl border border-slate-200 bg-white p-5">
      ...
      <section id="hakkimizda" className="dark-grid text-white">
        <div className="mx-auto flex min-h-[calc(100svh+96px)] max-w-6xl flex-col justify-center px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold sm:text-5xl">Güvenilir ve Deneyimli Ekip</h2>
            <p className="mt-4 text-slate-300">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <article key={stat.label} className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center">
                <p className="text-4xl font-extrabold text-blue-400">{stat.value}</p>
                <p className="mt-2 font-semibold text-slate-100">{stat.label}</p>
              </article>
            ))}
          </div>
        </div>
